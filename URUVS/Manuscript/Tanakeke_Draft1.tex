...
\subsection{Video Analysis \textgreater{} ALSO CHANGE BASED ON WHAT TYPES OF ANALYSES YOU RUN}\label{video-analysis-also-change-based-on-what-types-of-analyses-you-run}
...
\centering\centering
\caption{\label{tab:speciesFound}Animal groups identified. I WILL GET LOCAL NAMES SHORTLY}
\centering
\begin{tabular}[t]{llllll}
\toprule
Group Name & ID Level & Common Name (Eng) & Common Name (Ind) & Pulau Tanakeke Local Name & Locally Caught\\
\midrule
\cellcolor{gray!10}{Acrochordus granulatus} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Marine File Snake} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Care-care} & \cellcolor{gray!10}{}\\
Aronthron & Genus & Puffer Fish & Ikan Buntal & Buntal & dimakan\\
\cellcolor{gray!10}{Caranx} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Trevally} & \cellcolor{gray!10}{Ikan Kuwe} & \cellcolor{gray!10}{Juku kebo} & \cellcolor{gray!10}{dimakan}\\
Chaetodon & Genus & Butterfly Fish & Ikan Kepe-kepe & Ikan karang & hias\\
\cellcolor{gray!10}{Fibramia lateralis} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Humpback Cardinal} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Besing-besing} & \cellcolor{gray!10}{sebagai umpan}\\
\addlinespace
Gerres oyena & Species & Blacktip Silverbiddy & Ikan Kapas-kapas & Birangkasa & dimakan\\
\cellcolor{gray!10}{Hyporhampus} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Halfbeak} & \cellcolor{gray!10}{Ikan julung-julung} & \cellcolor{gray!10}{Ikan julung-julung} & \cellcolor{gray!10}{}\\
Lutjanus argentimaculatus & Species & Mangrove Red Snapper & Ikan Lencam & Katamba (LTP)
Sikuda (TMP) & dimakan\\
\cellcolor{gray!10}{Lutjanus ehrenbergii} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Blackspot Snapper} & \cellcolor{gray!10}{Kakap Garis} & \cellcolor{gray!10}{Ganrang eja} & \cellcolor{gray!10}{dimakan}\\
Monodactylus argenteus & Species & Moonyfishes or fingerfishes & Ikan Bebulan & Ikan Tapi-tapi & \\
\addlinespace
\cellcolor{gray!10}{Monodactylus argenteus} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Diamondfish} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Ikan Tapi-tapi} & \cellcolor{gray!10}{}\\
Mugilidae & Family & Mullet & Ikan Belanak & balanak & dimakan\\
\cellcolor{gray!10}{Omobranchus} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Blenny} & \cellcolor{gray!10}{Jabingan} & \cellcolor{gray!10}{Ikan toto} & \cellcolor{gray!10}{}\\
Ostorhinchus ocellicaudus & Species & Tailspot cardinalfish &  & Tontong & \\
\cellcolor{gray!10}{Scatophagus argus} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Spotted Scat} & \cellcolor{gray!10}{Ikan Kiper} & \cellcolor{gray!10}{Titam/Titang} & \cellcolor{gray!10}{dimakan}\\
\addlinespace
Siganus & Genus & Gold Spotted Rabbitfish & Ikan Baronang & Baronang & dimakan\\
\cellcolor{gray!10}{Sphaeramia orbicularis} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Orbicular Cardinalfish} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Besing-besing} & \cellcolor{gray!10}{dimakan}\\
Sphyraena barracuda & Species & Great Barracuda & Barakuda & Berang berang (TMP) & dimakan\\
\cellcolor{gray!10}{Terapon jarbua} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Crescent Grunter} & \cellcolor{gray!10}{Kerong Kerong} & \cellcolor{gray!10}{Kerong-kerong} & \cellcolor{gray!10}{}\\
...
In total, we identified 41 different animal groups, with 24 fish groups, 1 species of snake, 2 genuses of crab, and various species of shrimp (which were grouped together due to difficulty of identification). Of these, we were able to identify 13 groups to the species level, 6 genusus, and 1 group to the family level. After groups were identified down to their lowest taxonomic level, we asked fishers of both villages for the local name used for these fish (table \ref{speciesFound}).
...
A map of Tanakeke Island with village (desa) names (left). The right image shows the mangrove restoration sites on Tanakeke Island by Blue forests. Both images are courtesy of Blue Forests. I'M ALSO WAITING ON A MAP FROM AIS WITH THE VILLAGES AND THE SITES WE SAMPLED WRITE

\includegraphics{Tanakeke_Draft1_files/figure-latex/Timeseries-1.pdf} \includegraphics{Tanakeke_Draft1_files/figure-latex/Timeseries-2.pdf} \includegraphics{Tanakeke_Draft1_files/figure-latex/Timeseries-3.pdf} \includegraphics{Tanakeke_Draft1_files/figure-latex/Timeseries-4.pdf}

\newpage

\section{Possible other analyses}\label{possible-other-analyses}
...
\begin{figure}
\centering
\includegraphics{Tanakeke_Draft1_files/figure-latex/intermonthVAR-1.pdf}
\caption{\label{fig:intermonthVAR}I know the presentation of this data is ugly but these were calculations of intermonth variability in response variables at each site}
\end{figure}

\begin{figure}
\centering
\includegraphics{Tanakeke_Draft1_files/figure-latex/habitatPreference-1.pdf}
\caption{\label{fig:habitatPreference}habitat preference. This calculates the proportion of each species that were found in each site type. Most species seem to actally prefer the EMR sites, indicating a possible transition period?}
\end{figure}

\begin{figure}
\centering
\includegraphics{Tanakeke_Draft1_files/figure-latex/monthPreference-1.pdf}
\caption{\label{fig:monthPreference}month preference. This calculates the proportion of each species that were found in each month. June and september was a low month for a lot of species, but we see higher preferences for March, April, and July. I don't know why R put in the rest of the months of the year but I will remove if this ever gets used}
\end{figure}

\begin{figure}
\centering
\includegraphics{Tanakeke_Draft1_files/figure-latex/villagePreference-1.pdf}
\caption{\label{fig:villagePreference}Village preference. This calculates the proportion of each species that were found in each Village. A larger proportion of each species were found in Tompotana}
\end{figure}
