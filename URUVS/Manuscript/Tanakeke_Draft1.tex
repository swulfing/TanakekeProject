...
\toprule
Group Name & ID Level & Common Name (Eng) & Common Name (Ind)\\
\midrule
\cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
Acrochordus granulatus & Species & Marine File Snake & \\
\cellcolor{gray!10}{Aronthron} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Puffer Fish} & \cellcolor{gray!10}{Ikan Buntal}\\
Caranx & Genus & Trevally & Ikan Kuwe\\
\cellcolor{gray!10}{Chaetodon} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Butterfly Fish} & \cellcolor{gray!10}{Ikan Kepe-kepe}\\
\addlinespace
Epinephelus coioides & Species & Orangespotted Grouper & kerapu lumpur\\
\cellcolor{gray!10}{Fibramia lateralis} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Humpback Cardinal} & \cellcolor{gray!10}{}\\
Gerres oyena & Species & Blacktip Silverbiddy & Ikan Kapas-kapas\\
\cellcolor{gray!10}{Hyporhampus} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Halfbeak} & \cellcolor{gray!10}{Ikan julung-julung}\\
Lutjanus argentimaculatus & Species & Mangrove Red Snapper & Ikan Lencam\\
\addlinespace
\cellcolor{gray!10}{Lutjanus ehrenbergii} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Blackspot Snapper} & \cellcolor{gray!10}{Kakap Garis}\\
Monodactylus argenteus & Species & Moonyfishes or fingerfishes & Ikan Bebulan\\
\cellcolor{gray!10}{Monodactylus argenteus} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Diamondfish} & \cellcolor{gray!10}{}\\
Mugilidae & Family & Mullet & Ikan Belanak\\
\cellcolor{gray!10}{Omobranchus} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Blenny} & \cellcolor{gray!10}{Jabingan}\\
\addlinespace
Ostorhinchus ocellicaudus & Species & Tailspot cardinalfish & \\
\cellcolor{gray!10}{Parioglossus} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Dartfish} & \cellcolor{gray!10}{}\\
Pervagor nigrolineatus & Species & Blacklined Filefish & \\
\cellcolor{gray!10}{Portunidae} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Swimmer Crab} & \cellcolor{gray!10}{}\\
Scatophagus argus & Species & Spotted Scat & Ikan Kiper\\
\addlinespace
\cellcolor{gray!10}{Siganus} & \cellcolor{gray!10}{Genus} & \cellcolor{gray!10}{Gold Spotted Rabbitfish} & \cellcolor{gray!10}{Ikan Baronang}\\
Sphaeramia orbicularis & Species & Orbicular Cardinalfish & \\
\cellcolor{gray!10}{Sphyraena barracuda} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Great Barracuda} & \cellcolor{gray!10}{Barakuda}\\
Terapon jarbua & Species & Crescent Grunter & Kerong Kerong\\
\cellcolor{gray!10}{Toxotes jaculatrix} & \cellcolor{gray!10}{Species} & \cellcolor{gray!10}{Banded Archerfish} & \cellcolor{gray!10}{Ikan Sumpit}\\
\addlinespace
Unidentified Fish & NA &  & \\
\cellcolor{gray!10}{Unidentified Juvenile} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
Unidentified Shrimp & NA &  & \\
\bottomrule
\end{tabular}
\end{table}

In total, we identified 41 different animal groups, with 24 fish groups, 1 species of snake, 2 genuses of crab, and various species of shrimp (which were grouped together due to difficulty of identification). Of these, we were able to identify 15 groups to the species level, 8 genusus, and 1 group to the family level. After groups were identified down to their lowest taxonomic level, we asked fishers of both villages for the local name used for these fish (table \ref{speciesFound}).
